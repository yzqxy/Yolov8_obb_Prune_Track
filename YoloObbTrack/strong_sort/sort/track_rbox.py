...
class Track:
    ...
    def __init__(self, detection, rbox, track_id, class_id, conf, n_init, max_age, ema_alpha,
                 feature=None):
    ...
    def update(self, detection, class_id, conf):
        ...
        self.conf = conf
        self.class_id = class_id
        self.rbox = detection.rbox
        self.mean, self.covariance = self.kf.update(self.mean, self.covariance, detection.rbox, detection.confidence)
