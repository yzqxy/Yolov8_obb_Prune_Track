...
#                        border=(0, 0),no_rotato_ratio=0.5):
...
#     # Rotation and Scale
#     R = np.eye(3)
#     degrees_ratio=random.uniform(0,1)

#     # print('degrees_ratio',degrees_ratio)
#     if degrees_ratio>no_rotato_ratio:
...
#                     if targets[i][0]==0:
#                         new_targets.append(targets[i].tolist())
