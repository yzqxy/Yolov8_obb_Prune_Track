...
class LoadImagesAndLabels(Dataset):
    ...
    def __init__(self, path, cls_names, img_size=640, batch_size=16, augment=False, hyp=None, rect=False, image_weights=False,
        ...
        try:
            ...
            for p in path if isinstance(path, list) else [path]:
                p = Path(p)  # os-agnosticcache_labels
                if p.is_dir():  # dir
        ...
        for i, (label, segment) in enumerate(zip(self.labels, self.segments)):
            if include_class:
                # print('include_class_array',include_class_array)
    ...
    def __getitem__(self, index):
        ...
        # *[clsid poly] to *[clsid cx cy l s theta gaussian_θ_labels] θ∈[-pi/2, pi/2) non-normalized
            ...
            # print('labels_obb',labels_obb)
            # print('labels_obb1',labels_obb.shape)
        ...
        if hyp:
            c_num = 6 + hyp['cls_theta'] # [index_of_batch clsid cx cy l s theta gaussian_θ_labels]
        else:
            c_num = 7  #[index_of_batch clsid cx cy l s theta gaussian_θ_labels]
...
def load_mosaic(self, index):
    ...
    img4, labels4 = random_perspective(img4, labels4, segments4,
                                       ...
                                       no_rotato_ratio=self.hyp['no_rotato_ratio'])  # border to remove
        ...
        if os.path.isfile(lb_file):
            ...
            with open(lb_file) as f:
                ...
                for label in labels:
                    ...
                    # cls_id=name_list.index(label[8])
